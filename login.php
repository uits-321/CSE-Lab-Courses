                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <a href="login-candidates.php"><span class='mx-auto fw-bolder'>Candidate login</span></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <a href="login-company.php"><span class='mx-auto fw-bolder'>Company login</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
